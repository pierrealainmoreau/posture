...
export default function SpeedRetroLobbyPage() {
  ...
  useEffect(() => {
    ...
    async function fetchRoom() {
      ...
      if (data.status === "writing") router.push(`/retrospective/speed/${upperCode}/write`);
      else if (data.status === "voting") router.push(`/retrospective/speed/${upperCode}/vote`);
      else if (data.status === "finished") router.push(`/retrospective/speed/${upperCode}/results`);
    }
