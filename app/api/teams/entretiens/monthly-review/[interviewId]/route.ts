...
import type { MonthlyReviewData, MonthlyReviewInterview } from "@/lib/types";
...
export async function PUT(
  ...
  try {
    ...
    const updates = body as Partial<Pick<MonthlyReviewInterview, "data" | "status" | "interview_date">>;
    ...
    if (updates.data != null) payload.data = updates.data;
