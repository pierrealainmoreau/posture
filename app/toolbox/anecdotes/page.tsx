...
function RoomCard({ room }: { room: RoomRow }) {
  ...
  return (
    <Link
      href={`/toolbox/anecdotes/room/${room.code}/host`}
...
export default function AnecdotesPage() {
  ...
  async function createRoom() {
    ...
    setCreating(false);
    if (res.ok && data.code) router.push(`/toolbox/anecdotes/room/${data.code}/host`);
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex flex-col">
      <Header backHref="/" parentHref="/toolbox" parentLabel={t.common.miniJeux} currentTool="Anecdotes" />
