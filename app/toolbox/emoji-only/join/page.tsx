...
function JoinForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch(`/api/emoji-only/room/${upperCode}/players`, {
        method: "POST",
...
export default function EmojiOnlyJoinPage() {
  return (
    <Suspense>
      <JoinForm />
    </Suspense>
