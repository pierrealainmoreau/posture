...
import { BarChart2, Plus, Hash, ChevronRight, Clock, Users, CheckCircle2, Loader2 } from "lucide-react";
...
function RoomCard({ room }: { room: RoomRow }) {
  ...
  return (
    <Link
      href={`/toolbox/estimation-express/${room.code}/lobby`}
    ...
    >
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400">{room.total_questions} questions</p>
...
export default function EstimationExpressPage() {
  ...
  useEffect(() => {
    fetch("/api/estimation-express/room", { cache: "no-store" })
      .then((r) => r.json())
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-6 py-10">
        <div className="flex items-start justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-semibold text-gray-900 dark:text-white">Estimation Express</h1>
              <p className="text-sm text-gray-400 dark:text-gray-500 mt-0.5">
                Placez le curseur le plus près de la bonne réponse — rapidité et précision comptent.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-3 mb-8">
          ...
          <Link
            href="/toolbox/estimation-express/join"
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            <div className="w-14 h-14 rounded-2xl bg-violet-50 dark:bg-violet-950 flex items-center justify-center mx-auto mb-4">
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500">
              Choisissez vos questions et partagez le code à vos collègues.
            </p>
          </div>
        ) : (
