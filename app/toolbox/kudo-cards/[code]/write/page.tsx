...
export default function KudoWritePage() {
  ...
  useEffect(() => {
    ...
    if (!stored) { router.replace(`/toolbox/kudo-cards/join?code=${upperCode}`); return; }
    try {
      ...
      router.replace(`/toolbox/kudo-cards/join?code=${upperCode}`);
    }
  ...
  useEffect(() => {
    ...
    async function fetchRoom() {
      ...
      if (data.status === "lobby") { router.replace(`/toolbox/kudo-cards/${upperCode}/lobby`); return; }
      if (data.status === "revealed") { router.push(`/toolbox/kudo-cards/${upperCode}/wall`); return; }
