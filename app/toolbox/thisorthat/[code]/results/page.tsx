...
const GAME_JOIN_PATHS: Record<string, string> = {
  ...
  completephrase: "/toolbox/completephrase/join",
  humeur:        "/toolbox/humeur/join",
  chaine:        "/toolbox/chaine/join",
  undercover:    "/toolbox/undercover/join",
  draw:          "/toolbox/draw/join",
  code_secret:   "/toolbox/code-secret/join",
  tribu:         "/toolbox/tribu/join",
};
...
export default function ThisOrThatResultsPage() {
  ...
  useEffect(() => {
    async function load() {
      ...
      if (data.status === "lobby") { router.replace(`/toolbox/thisorthat/${upperCode}/lobby`); return; }
      if (data.status === "playing") { router.replace(`/toolbox/thisorthat/${upperCode}/play`); return; }
      ...
      <main className="flex-1 max-w-lg mx-auto w-full px-4 py-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          {isHost ? (
            <>
              <Link
                href="/toolbox/thisorthat/create"
