...
export default function HumeurPlayPage() {
  ...
  useEffect(() => {
    ...
    async function init() {
      ...
      if (data.status === "finished") { router.replace(`/toolbox/humeur/${upperCode}/results`); return; }
  ...
  useEffect(() => {
    ...
    async function pollRoom() {
      ...
      const data = await res.json() as HumeurRoom & { players: HumeurPlayer[] };
      setPlayers(data.players ?? []);
      if (data.status === "finished") router.push(`/toolbox/humeur/${upperCode}/results`);
    }
  ...
  async function handleReveal() {
    ...
    try {
      ...
      router.push(`/toolbox/humeur/${upperCode}/results`);
    } catch {
      setRevealing(false);
    }
  }
