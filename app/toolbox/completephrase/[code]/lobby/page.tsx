...
export default function CompletePhraseLobbyPage() {
  ...
  const shareUrl =
    typeof window !== "undefined"
      ? `${window.location.origin}/toolbox/completephrase/join?code=${upperCode}`
      : "";
  ...
  useEffect(() => {
    ...
    async function fetchRoom() {
      ...
      if (data.status === "playing") router.push(`/toolbox/completephrase/${upperCode}/play`);
      else if (data.status === "finished") router.push(`/toolbox/completephrase/${upperCode}/results`);
    }
