...
export default function SpeedRetroWritePage() {
  ...
  useEffect(() => {
    ...
    async function fetchRoom() {
      ...
      if (data.status === "voting") router.push(`/mini-jeux/speed-retro/${upperCode}/vote`);
      else if (data.status === "finished") router.push(`/mini-jeux/speed-retro/${upperCode}/results`);
