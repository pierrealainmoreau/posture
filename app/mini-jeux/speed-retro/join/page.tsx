...
function JoinForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch(`/api/speed-retro/room/${upperCode}/players`, {
        method: "POST",
...
export default function SpeedRetroJoinPage() {
  return (
    <Suspense>
      <JoinForm />
    </Suspense>
