...
function JoinForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch(`/api/undercover/room/${upperCode}/players`, {
        method: "POST",
...
export default function UndercoverJoinPage() {
  return (
    <Suspense>
      <JoinForm />
    </Suspense>
