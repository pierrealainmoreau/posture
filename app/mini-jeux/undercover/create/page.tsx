...
export default function UndercoverCreatePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/undercover/room", {
        method: "POST",
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-5 space-y-5">
            ...
            <div className="bg-indigo-50 dark:bg-indigo-950/40 border border-indigo-100 dark:border-indigo-900 rounded-xl p-4">
              <p className="text-xs font-semibold text-indigo-700 dark:text-indigo-300 mb-1">
                Les mots secrets sont tirés automatiquement
              </p>
              <p className="text-xs text-indigo-600 dark:text-indigo-400">
                Une paire de mots proches est assignée au démarrage. Vous pourrez ajuster le nombre d&apos;Undercovers et de Mr. White dans le lobby.
              </p>
            </div>
          </div>
