...
export default function HostPage() {
  ...
  const shareUrl = typeof window !== "undefined"
    ? `${window.location.origin}/mini-jeux/anecdotes/room/${upperCode}`
    : "";
  ...
  const breadcrumbs = [
    ...
    { href: "/mini-jeux/anecdotes", label: "Anecdotes" },
    { label: upperCode },
  ];
  ...
  async function fetchData() {
    ...
    if (roomRes.status === 403) { router.replace("/mini-jeux/anecdotes"); return; }
