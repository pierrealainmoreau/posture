...
export default function KudoWritePage() {
  ...
  useEffect(() => {
    ...
    if (!stored) { router.replace(`/mini-jeux/kudo-cards/join?code=${upperCode}`); return; }
    try {
      ...
      router.replace(`/mini-jeux/kudo-cards/join?code=${upperCode}`);
    }
  ...
  useEffect(() => {
    ...
    async function fetchRoom() {
      ...
      if (data.status === "lobby") { router.replace(`/mini-jeux/kudo-cards/${upperCode}/lobby`); return; }
      if (data.status === "revealed") { router.push(`/mini-jeux/kudo-cards/${upperCode}/wall`); return; }
