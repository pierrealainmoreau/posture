...
export default function ThisOrThatLobbyPage() {
  ...
  const shareUrl =
    typeof window !== "undefined"
      ? `${window.location.origin}/mini-jeux/thisorthat/join?code=${upperCode}`
      : "";
  ...
  useEffect(() => {
    ...
    async function fetchRoom() {
      ...
      if (data.status === "playing") {
        router.push(`/mini-jeux/thisorthat/${upperCode}/play`);
      } else if (data.status === "finished") {
        router.push(`/mini-jeux/thisorthat/${upperCode}/results`);
      }
    }
