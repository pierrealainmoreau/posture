...
function JoinForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch(`/api/chaine/room/${upperCode}/players`, {
        method: "POST",
      ...
      if (!res.ok) {
        ...
        else if (res.status === 409) setError("La partie a déjà commencé. Rejoins quand même — tu verras la chaîne en cours.");
...
export default function ChaineJoinPage() {
  return (
    <Suspense>
      <JoinForm />
    </Suspense>
