...
function RoomCard({ room }: { room: RoomRow }) {
  ...
  return (
    <Link
      href={`/mini-jeux/tvml/room/${room.code}/host`}
...
export default function TvmlPage() {
  ...
  async function createRoom() {
    ...
    setCreating(false);
    if (res.ok && data.code) router.push(`/mini-jeux/tvml/room/${data.code}/host`);
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex flex-col">
      <Header backHref="/" parentHref="/mini-jeux" parentLabel="Mini-jeux" currentTool="2 Vérités 1 Mensonge" />
