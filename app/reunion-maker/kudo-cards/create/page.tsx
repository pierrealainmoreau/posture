...
export default function KudoCreatePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/kudo-cards/room", {
        method: "POST",
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex flex-col">
      ...
      <main className="flex-1 max-w-md mx-auto w-full px-6 py-10">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
          Partagez le code à votre équipe. Vous déclencherez la révélation des cartes.
        </p>
