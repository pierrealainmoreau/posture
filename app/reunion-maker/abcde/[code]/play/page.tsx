...
export default function AbcdePlayPage() {
  ...
  const fetchRoom = useCallback(async () => {
    ...
    if (data.status === "lobby") router.push(`/reunion-maker/abcde/${upperCode}/lobby`);
    if (data.status === "finished") router.push(`/reunion-maker/abcde/${upperCode}/results`);
  ...
  async function synthesize() {
    ...
    else router.push(`/reunion-maker/abcde/${upperCode}/results`);
