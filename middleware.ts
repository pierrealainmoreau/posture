...
export async function middleware(request: NextRequest) {
  ...
  // Coach manual, career & mid-year self-assessment pages are public — token = access credential.
  const isCoachManualPage =
    pathSegments[1] === "teams" &&
    (pathSegments[2] === "manual" || pathSegments[2] === "career" || pathSegments[2] === "mid-year") &&
    pathSegments[3] !== undefined;
