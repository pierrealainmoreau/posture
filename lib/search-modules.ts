export const MODULES = [
  { id: "humeur",           name: "Humeur du jour",        description: "Prenez la température en temps réel — chaque participant vote sur son état d'esprit.", href: "/mini-jeux/humeur",          emoji: "😊" },
  ...
  { id: "anecdotes",        name: "Anecdotes",             description: "Devinez qui a vécu quelle anecdote — idéal pour mieux se connaître en équipe.",           href: "/mini-jeux/anecdotes",       emoji: "📖" },
  { id: "draw",             name: "Draw It",               description: "Dessinez un mot pendant que vos collègues devinent — créativité et fous rires garantis.", href: "/mini-jeux/draw",            emoji: "🎨" },
  { id: "chaine",           name: "Chaîne de mots",        description: "Jeu d'association de mots en tour par tour avec vote sur la surprise du mot suivant.",     href: "/mini-jeux/chaine",          emoji: "🔗" },
  { id: "undercover",       name: "Undercover",            description: "Jeu de rôle : chaque joueur décrit son mot en secret, trouvez l'imposteur.",               href: "/mini-jeux/undercover",      emoji: "🕵️" },
  { id: "tribu",            name: "Tribu",                 description: "Découvrez à quelle tribu appartient chaque membre selon ses préférences et réflexes.",    href: "/mini-jeux/tribu",           emoji: "🏕️" },
  { id: "tvml",             name: "Tout vrai mon lapin",   description: "Vrai ou faux ? Des anecdotes vraies ou inventées sur vos collègues à deviner.",            href: "/mini-jeux/tvml",            emoji: "🎭" },
